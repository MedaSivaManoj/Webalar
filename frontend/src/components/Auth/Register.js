...
const Register = () => {
  ...
  return (
    <div className="register-page" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(120deg, #fceabb 0%, #f8b500 100%)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        >
          <div style={{ marginBottom: 24, textAlign: 'center' }}>
            <h2 style={{ color: '#f8b500', fontWeight: 800, letterSpacing: 1, fontSize: 28, marginBottom: 4, textShadow: '0 2px 8px #fffde4, 0 1px 0 #f8b500' }}>Create Account</h2>
            <p style={{ color: '#b28704', fontSize: '1rem', margin: 0, fontWeight: 600 }}>Sign up to get started</p>
          </div>
          <form onSubmit={handleSubmit} className="auth-form" autoComplete="off" style={{ width: '100%' }}>
            <div style={{ position: 'relative', marginBottom: 18, width: '100%' }}>
              <FaUser style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', color: '#f8b500', fontSize: 18, pointerEvents: 'none' }} />
              <input
                name="username"
          ...
          >
            ...
            <span style={{ color: '#f8b500', textDecoration: 'underline', fontWeight: 600 }}>Login</span>
          </p>
        </div>
      </div>
    </div>
